...
You can look up refunds for a specific bundle by using the [buildernet_getFeeRefundsByBundle](https://docs.flashbots.net/flashbots-auction/advanced/rpc-endpoint#buildernet_getfeerefundsbybundle) API.
