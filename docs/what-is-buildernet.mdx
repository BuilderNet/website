...
After the official launch, BuilderNet changed its extra data to `BuilderNet (operator)` and landed its first mainnet block on November 26, 2024 at slot `10,483,748`, block number `21,272,327`, with block hash `0x86a32583045f379cfd483b8a5ddeaf927c73cc8c510785113c05caf35f0190e8` and extra data `BuilderNet (Beaver)`.
